...
<form class="form-horizontal" role="form" style="margin-top: 30px;" action="show1.htm" method="post">


	<div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Question Id:</label>
    <div class="col-sm-8" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="pwd" placeholder="enter the question id to modify" name="ques_id">
    </div>
  </div>
