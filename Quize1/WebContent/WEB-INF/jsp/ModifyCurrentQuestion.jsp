...
<div class="container"  align="center"  >
	<div class="panel panel-default" style="margin-top: 100px;width: 800px; ">
      <div class="panel-heading">Modifying an existing Question</div>
    
<form class="form-horizontal" role="form" style="margin-top: 30px;" action="mod.htm" method="post">
  ...
  <label class="control-label col-sm-2" for="cat">Select list:</label>
   <div class="col-sm-10" style="padding-right:30px;"> 
	...
	<option value="5">Another</option>
      ...
      <input type="hidden" class="form-control" value="${ques_id }" name="ques_id">

  <div class="form-group">
    <label class="control-label col-sm-2" for="pwd" >Question:</label>
     <div class="col-sm-10" style="padding-right:30px;"> 
      <textarea class="form-control" rows="5" id="comment" name="question">${question }</textarea>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="pwd" placeholder="Option1" value="${option1 }"  name="option1">
    </div>
  </div>
    ...
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="pwd" placeholder="Option2" value="${option2 }" name="option2">
    </div>
  </div>
	<div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Option3:</label>
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="pwd" placeholder="Option3" value="${option3 }" name="option3">
    </div>
  </div>
	<div class="form-group">
    <label class="control-label col-sm-2" for="pwd">Option4:</label>
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="pwd" placeholder="Option4" value="${option4 }" name="option4">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10" style="padding-right:30px;"> 
      <input type="text" class="form-control" id="pwd" placeholder="Option4" value="${right_answer }" name="right_answer">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10" align="left">
      <button type="submit" class="btn btn-default">Modify question</button>
    </div>
  </div>
</form>
</div>
