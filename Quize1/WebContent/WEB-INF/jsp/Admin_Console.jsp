    ...
    <div class="container">
      ...
      <div class="row">
		...
		<!-- LIVE VISITORS BLOCK -->     
      		<div class="half-unit">
	      		...
	      		<div class="cont">
      			<p><bold>388</bold></p>
      			<p><img src="up-small.png" alt=""> 412 Max. | <img src="http://www.prepbootstrap.com/Content/images/shared/single-page-admin/down-small.png" alt=""> 89 Min.</p>
	      		</div>
      		</div>
	  ...
	  <!-- PAGE VIEWS BLOCK -->     
      		<div class="half-unit">
      			...
      			<p><img src="up-small.png" alt=""> 23.88%</p>
	      		</div>
      		</div>
      	</div>
      ...
      <!-- SERVER UPTIME -->
			<div class="half-unit">
	      		...
	      		<hr>
	      		<div class="cont">
					<p><img src="up.png" alt=""> <bold>Up</bold> | 356ms.</p>
				</div>
			</div>
	  ...
	  <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	            ...
	            <div class="flexslider">
					<ul class="slides">
						<li><img src="slide01.png" alt="slider"></li>
						<li><img src="slide02.png" alt="slider"></li>
					</ul>
            </div>
				<div class="cont">
